...
public class AverageSalaryOfMaleAndFemaleEmpTest {
	...
	public static void main(String[] args) {
		...
		Map<String, Double> averageSalaryOfMaleAndFemaleEmployee=emplList.stream().collect(Collectors.groupingBy(Employee::getGender,Collectors.averagingDouble(Employee::getSalary)));
